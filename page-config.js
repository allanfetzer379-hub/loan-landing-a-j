(function () {
  ...
  const defaults = {
    company_name: "中喬資產管理有限公司",
    line_id: "@703umlsa",
    line_url: "https://line.me/R/ti/p/@703umlsa",
    pixel_ids: [
      { id: "975921495153095", enabled: true, platform: "facebook" },
      { id: "1536999554563543", enabled: true, platform: "facebook" },
      { id: "D8LPVURC77UDGKSVKKU0", enabled: true, platform: "tiktok" }
    ]
  };
  ...
  async function loadConfig() {
    ...
    try {
      ...
      console.warn("A project settings fallback used:", error);
    }
